  ...
  <div class="ccn-identify-course-intro">
    <div class="cs_instructor">
      <ul class="cs_instrct_list float-left mb0">
        <li class="list-inline-item"><img class="thumb" src="http://demo.createdbycocoon.com/moodle/edumy/2/pluginfile.php/162/block_cocoon_course_intro/content/4.png" alt="4.png"/></li>
        <li class="list-inline-item"><a class="" href="#">Ali Tufan</a></li>
        <li class="list-inline-item"><a class="" href="#">Last updated 21 December 2019</a></li>
      </ul>
      <ul class="cs_watch_list float-right mb0">
        <li class="list-inline-item"><a class="" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http://demo.createdbycocoon.com/moodle/edumy/2/course/view.php?id=11"><span class="flaticon-share"> Share</span></a></li>
      </ul>
    </div>
    <h3 class="cs_title ">Fashion Photography From Professional</h3>
    ...
    <ul class="cs_review_enroll">
      <li class="list-inline-item"><a class="" href="#"><span class="flaticon-profile"></span> 2 students enrolled</a></li>
      <li class="list-inline-item"><a class="" href="#"><span class="flaticon-comment"></span> 5 topics</a></li>
    </ul>
    </div>
...
<ul class="list_requiremetn">
  ...
  <div class="about_ins_container">
    ...
    <div class="about_ins_info">
      <div class="thumb"><img src="http://demo.createdbycocoon.com/moodle/edumy/2/pluginfile.php/164/block_cocoon_course_instructor/content/6.png" alt="6.png"/></div>
    </div>
    <div class="details">
...
<ul class="about_ins_list mb0">
  ...
  <div class="">
    <div style={{display:'none'}} id="cmt-tmpl"><div class="comment-message media csv1"><div class="comment-message-meta mr-3"><span class="picture">___picture___</span> - </div><div class="text media-body"><h4 class="sub_title mt-0 mb0">___name___</h4><span class="sspd_postdate fz14">___time___</span>___content___</div></div><div class="custom_hr"></div></div><div class="mdl-left"><a class="showcommentsnonjs" href="http://demo.createdbycocoon.com/moodle/edumy/2/course/view.php?id=11&amp;nonjscomment=1&amp;comment_itemid=0&amp;comment_context=156&amp;comment_component=block_comments&amp;comment_area=page_comments">Show comments</a><div id="comment-ctrl-64801c8a3ed49" class="comment-ctrl" style={{display:'block'}}><ul id="comment-list-64801c8a3ed49" class="comment-list comments-loaded"><li class="first"></li><li id="comment-19-64801c8a3ed49"><div class="comment-message media csv1"><div class="comment-message-meta mr-3"><span class="picture"><a href="http://demo.createdbycocoon.com/moodle/edumy/2/user/view.php?id=5&amp;course=11"><img src="http://demo.createdbycocoon.com/moodle/edumy/2/pluginfile.php/222/user/icon/edumy/f2?rev=3801" class="align-self-start mr-3 ccn_userpicture" width="18" height="18" alt="Picture of Krisztina Szer" title="Picture of Krisztina Szer"/></a></span> - </div><div class="text media-body"><h4 class="sub_title mt-0 mb0">Krisztina Szer</h4><span class="sspd_postdate fz14">Fri, 3 Jan 2020, 12:54 AM</span><div class="no-overflow"><div class="text_to_html fz15 mt20">This is the second Photoshop course I have completed with Cristian. Worth every penny and recommend it highly. To get the most out of this course, its best to to take the Beginner to Advanced course first.<br/>
<br/>
The sound and video quality is of a good standard. Thank you Cristian.</div></div></div></div><div class="custom_hr"></div></li><li id="comment-27-64801c8a3ed49"><div class="comment-message media csv1"><div class="comment-message-meta mr-3"><span class="picture"><a href="http://demo.createdbycocoon.com/moodle/edumy/2/user/view.php?id=5&amp;course=11"><img src="http://demo.createdbycocoon.com/moodle/edumy/2/pluginfile.php/222/user/icon/edumy/f2?rev=3801" class="align-self-start mr-3 ccn_userpicture" width="18" height="18" alt="Picture of Krisztina Szer" title="Picture of Krisztina Szer"/></a></span> - </div><div class="text media-body"><h4 class="sub_title mt-0 mb0">Krisztina Szer</h4><span class="sspd_postdate fz14">Fri, 3 Jan 2020, 12:55 AM</span><div class="no-overflow"><div class="text_to_html fz15 mt20">This is the second Photoshop course I have completed with Cristian. Worth every penny and recommend it highly. To get the most out of this course, its best to to take the</div></div></div></div><div class="custom_hr"></div></li></ul><div id="comment-pagination-64801c8a3ed49" class="comment-pagination"></div></div></div>
  ...
  <div class="">
      <div class="instructor_pricing_widget">
                                      ...
                                      <div class="ccn-buy-access">Paid course entry</div><ul class="price_quere_list text-left"><li><div class="ccn-course-details-item"><span class="flaticon-play-button-1"></span> 11 hours on-demand video</div></li><li><div class="ccn-course-details-item"><span class="flaticon-download"></span> 69 downloadable resources</div></li><li><div class="ccn-course-details-item"><span class="flaticon-key-1"></span> Full lifetime access</div></li><li><div class="ccn-course-details-item"><span class="flaticon-responsive"></span> Access on mobile and TV</div></li><li><div class="ccn-course-details-item"><span class="flaticon-flash"></span> Assignments</div></li><li><div class="ccn-course-details-item"><span class="flaticon-award"></span> Certificate of Completion</div></li></ul>
          </div>
  ...
  <ul class="tag_list">
        <li class="list-inline-item">
            <a href="http://demo.createdbycocoon.com/moodle/edumy/2/tag/index.php?tc=1&amp;tag=Beginner&amp;from=156" class=" s10" title="Entries: 1">
                        Beginner</a>
        </li>
        <li class="list-inline-item">
            <a href="http://demo.createdbycocoon.com/moodle/edumy/2/tag/index.php?tc=1&amp;tag=Marketing&amp;from=156" class=" s10" title="Entries: 1">
                        Marketing</a>
        </li>
        <li class="list-inline-item">
            <a href="http://demo.createdbycocoon.com/moodle/edumy/2/tag/index.php?tc=1&amp;tag=Photoshop&amp;from=156" class=" s20" title="Entries: 2">
                        Photoshop</a>
        </li>
        <li class="list-inline-item">
            <a href="http://demo.createdbycocoon.com/moodle/edumy/2/tag/index.php?tc=1&amp;tag=Sketch&amp;from=156" class=" s20" title="Entries: 2">
                        Sketch</a>
        </li>
  </ul>
</div>
